...
const RECOVERY_POINTS = [
  ...
  { title: 'Link expires automatically', description: 'Expires after a short time for your safety', icon: FiClock },
  { title: 'Your account stays protected', description: 'No changes until you confirm the reset', icon: FiLock },
        ...
        >
          ...
          >
            ...
            <Stack spacing={2.5}>
              ...
              >
                Don&apos;t worry, it happens. We&apos;ll help you securely reset
                your password and get you back to learning in just a few minutes.
              </Typography>
            </Stack>

            <Stack spacing={2}>
              {RECOVERY_POINTS.map(({ title, description, icon: Icon }, index) => (
                <motion.div
                  key={title}
                  custom={index}
                  initial="hidden"
