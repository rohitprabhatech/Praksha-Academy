...
const AddBatch = () => {
  ...
  useEffect(() => {
    const loadClasses = async () => {
      try {
        ...
        setError(
          err.message || 'Unable to load classes.'
        )
      } finally {
  ...
  return (
    ...
    >
      <PageHeader
        title="Add Batch"
        subtitle="Create a new academic batch."
        breadcrumbs={[
          {
            label: 'Admin',
            to: '/admin/dashboard',
          ...
          <Stack spacing={2.5}>
            ...
            >
              ...
              <Box>
                ...
                >
                  Enter the batch name, class, course and status.
                </Typography>
              </Box>
            </Stack>
            ...
            <TextField
              ...
              helperText={
                errors.name || 'Enter a unique batch name.'
              }
              required
              fullWidth
              disabled={loading}
