...
const validate = (values) => {
  ...
  if (!values.message.trim()) {
    ...
    errors.message =
      "A few more details would help (10+ characters)";
  }
    ...
    return (
      ...
      >
        <Alert severity="success" sx={{ mb: 3 }}>
          Thanks, {submittedName || "there"}. We've received
          your message.
        </Alert>
        ...
        >
          A team member will review it and get back to you.
          In the meantime, you're welcome to keep browsing.
        </Typography>
      ...
      <div className="row g-3">
        ...
        <div className="col-md-6">
          <TextField
            ...
            disabled={status === "submitting"}
          >
            {contactData.programInterests.map(
              (option) => (
                <MenuItem
                  key={option}
                  value={option}
